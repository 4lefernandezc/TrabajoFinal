...
const routes = [
  ...
  { path: '/especialidades' , component: Especialidades, meta: { requiresAuth: true } },
  { path: '/pacientes', component: Pacientes, meta: { requiresAuth: true } },
  { path: '/citas', component: () => import('../components/Reservas.vue'), meta: { requiresAuth: true } },
  { path: '/doctores', component: () => import('../components/Doctores.vue'), meta: { requiresAuth: true } },
]
